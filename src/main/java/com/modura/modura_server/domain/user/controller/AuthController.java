...
public class AuthController {
    ...
    @PostMapping("/login")
    public ApiResponse<UserResponseDTO.KakaoLoginDTO> kakaoLogin(@Valid @RequestBody UserRequestDTO.KakaoLoginDTO request) {

        UserResponseDTO.KakaoLoginDTO response = userCommandService.kakaoLogin(request);
